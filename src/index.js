...
const typesArray = loadFilesSync(path.join(__dirname, './graphql/schema'), { extensions: ['graphql'], recursive: true });
const typeDefs = mergeTypeDefs(typesArray);
const resolversArray = loadFilesSync(path.join(__dirname, './graphql/resolvers'), { recursive: true });
